...
# df = pd.read_csv("./data/k-anonymity/data1.csv", sep=",", header=None, names=names, index_col=False, engine='python');
...
def build_anonymized_dataset(df, partitions, feature_columns, sensitive_column, max_partitions=None):
    ...
    for i, partition in enumerate(partitions):
       ...
       # print(df.loc[partition])
        ...
        # grouped_columns = df.loc[partition].agg(aggregations, squeeze=False) # 临时封印
